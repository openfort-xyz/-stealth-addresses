...
import { pad, toHex, encodeFunctionData, concat, Address, Hex } from "viem";
import { formatUserOperationRequest, formatUserOperationGas, toPackedUserOperation } from "viem/account-abstraction";

export async function _registerMetaAddress(account: Account, paymasterSignerAccount: PrivateKeyAccount, stealthMetaAddress: Hex) {
