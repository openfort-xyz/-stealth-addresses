...
interface IERC5564Announcer {
    ...
    /// - When sending/interacting with the native token of the blockchain (cf. ETH), the metadata SHOULD be structured
    /// as follows: - Byte 1 MUST be the view tag, as specified above.
